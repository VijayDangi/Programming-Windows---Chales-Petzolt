    ...
    switch(message)
    {
        case WM_CREATE:
            hInstance = (HINSTANCE) GetWindowLong(hwnd, GWL_HINSTANCE);
                ...
                //Create the white-rectangle window against which the scroll bars
                //will be positioned. The Child Window ID is 9.
            ...
            for(i = 0; i < 3; i++)
            {
                    ...
                    g_OldScroll[i] = (WNDPROC) SetWindowLong(hwndScroll[i], GWL_WNDPROC, (LONG) ScrollProc);
...
LRESULT CALLBACK ScrollProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    return (CallWindowProc(g_OldScroll[id], hwnd, message, wParam, lParam));
}
