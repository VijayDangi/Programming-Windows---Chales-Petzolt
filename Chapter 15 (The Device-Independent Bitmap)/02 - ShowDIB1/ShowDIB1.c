        ...
        case WM_COMMAND:
            switch(LOWORD(wParam))
            {
                case IDM_FILE_OPEN:
                    ...
                    if(pbmfh == NULL)
                    {
                        MessageBox(hwnd, TEXT("Cannot load DIB file"), szAppName, MB_ICONERROR);
                        return(0);
                    }
                ...
                case IDM_FILE_SAVE:
                    ...
                    if(!bSuccess)
                        MessageBox(hwnd, TEXT("Cannot save DIB file"), szAppName, MB_ICONERROR);
            ...
            hdc = BeginPaint(hwnd, &ps);
                ...
                if(pbmfh)
                {
                    SetDIBitsToDevice(
                        ...
                        pbmi,   //pointer to DIB information
