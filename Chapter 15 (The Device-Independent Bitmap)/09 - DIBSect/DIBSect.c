/*--------------------------------------------------------
    DIBSect:- Displays a DIB Section in the client area
--------------------------------------------------------*/
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    HBITMAP CreateDibSectionFromDibFile(PTSTR);
        ...
        case WM_COMMAND:
            switch(LOWORD(wParam))
            {
                case IDM_FILE_OPEN:
                    ...
                    //Craete the DIB Section from the DIB file
...
HBITMAP CreateDibSectionFromDibFile(PTSTR szFileName)
{
    ...
    //code
    //open file: read access, prohibit write access
    ...
    free(pbmi);
    CloseHandle(hFile);
    //pBits() is owned by the system. The memory is automstically freed when you delete the bitmap by calling DeleteObject()
