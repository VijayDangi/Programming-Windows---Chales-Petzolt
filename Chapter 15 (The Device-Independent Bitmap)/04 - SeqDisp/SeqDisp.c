/*------------------------------------------
    SeqDisp :- Sequential Display of DIBs
------------------------------------------*/
        ...
        case WM_COMMAND:
            ...
            switch(LOWORD(wParam))
            {
                case IDM_FILE_OPEN:
                    ...
                    {
                        MessageBox(hwnd, TEXT("Cannot read file."), szAppName, MB_ICONWARNING | MB_OK);
                        CloseHandle(hFile);
                        return(0);
                    }
                    ...
                    {
                        MessageBox(hwnd, TEXT("Cannot read filr."), szAppName, MB_ICONWARNING | MB_OK);
                    ...
                    for(y = 0; y < cyDib; y++)
                    {
                        ...
                        SetDIBitsToDevice(
                            ...
                            0,          //xSrc
                            0,          //ySrc
                            bTopDown ? cyDib - y - 1 : y,   //first scan line
