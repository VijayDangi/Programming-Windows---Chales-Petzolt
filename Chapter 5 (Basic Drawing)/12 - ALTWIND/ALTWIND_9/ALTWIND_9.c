...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	switch(message)
	{
        case WM_CREATE:
            ...
            // {
                // if (i % 8 == 0) 
                    // bBrushBits[i/8] = bBrushBits[i/8] ^ 0x800000; 
                 // else if (i % 8 == 1) 
                    // bBrushBits[i/8] = bBrushBits[i/8] ^ 0x400000; 
                 // else if (i % 8 == 2) 
                    // bBrushBits[i/8] = bBrushBits[i/8] ^ 0x200000; 
                 // else if (i % 8 == 3) 
                    // bBrushBits[i/8] = bBrushBits[i/8] ^ 0x100000; 
                 // else if (i % 8 == 4) 
                    // bBrushBits[i/8] = bBrushBits[i/8] ^ 0x080000; 
                 // else if (i % 8 == 5) 
                    // bBrushBits[i/8] = bBrushBits[i/8] ^ 0x040000; 
                 // else if (i % 8 == 6) 
                    // bBrushBits[i/8] = bBrushBits[i/8] ^ 0x020000; 
                 // else if (i % 8 == 7) 
                    // bBrushBits[i/8] = bBrushBits[i/8] ^ 0x010000; 
            // }
            return(0);
		...
		case WM_PAINT:
		{
			...
			HBITMAP hBitmap = CreateBitmap(8, 8, 1, 8, (LPBYTE)bBrushBits); 
