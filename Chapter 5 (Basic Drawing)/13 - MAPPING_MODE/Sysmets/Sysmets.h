...
sysmetrics[] = {
	...
	SM_CXFIXEDFRAME, 		TEXT("SM_FIXEDFRAME"), 				TEXT("Dialog window fixed frame"),
	SM_CYFIXEDFRAME, 		TEXT("SM_CYFIXEDFRAME"), 			TEXT("Dialog window fixed height"),
	...
	SM_CXVSCROLL, 			TEXT("SM_CXVSCROLL"), 				TEXT("Vertical scroll arrow width"),
	...
	SM_CYHSCROLL, 			TEXT("SM_CYHSCROLL"), 				TEXT("Horizontal scroll arrow height"),
